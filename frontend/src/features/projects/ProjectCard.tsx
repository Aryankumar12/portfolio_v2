...
const ProjectCard = ({ obj }: Object) => {
  ...
  return (
   <div
  className={`flex flex-col justify-between text-center border
    p-4 sm:p-6
    max-w-md w-full rounded-lg shadow-sm h-full transition-colors duration-300
    ${
      isDark
...
>
  ...
  <p
    className={`my-1 sm:my-2 text-sm ${
